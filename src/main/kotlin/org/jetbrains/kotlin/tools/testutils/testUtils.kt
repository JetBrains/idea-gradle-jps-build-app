...
fun buildProject(project: Project?): Boolean {
    ...
    if (project == null) {
        ...
        //CompilerWorkspaceConfiguration.getInstance(project).COMPILER_PROCESS_ADDITIONAL_VM_OPTIONS = "-agentlib:jdwp=transport=dt_socket,server=y,suspend=y,address=6092"
